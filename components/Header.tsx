...
import { Wifi, WifiOff, BookOpen, Settings, Moon, Sun, Languages } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          <div 
            ...
            title={ankiStatus === AnkiConnectionStatus.CONNECTED ? t.ankiConnected : t.ankiDisconnected}
          >
            {ankiStatus === AnkiConnectionStatus.CONNECTED ? <Wifi size={14} /> : <WifiOff size={14} />}
            <span>{ankiStatus === AnkiConnectionStatus.CONNECTED ? t.ankiConnected : t.ankiDisconnected}</span>
          </div>
          ...
          <div className="h-6 w-px bg-slate-200 dark:bg-slate-700 hidden sm:block"></div>
           ...
           <button
            ...
            className="p-2 flex items-center gap-1 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition-all font-medium text-sm w-12 justify-center"
